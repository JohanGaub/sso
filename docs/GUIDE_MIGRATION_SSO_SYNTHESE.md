...
|-----------|------|----------------|
| OIDC | Gestion managée (attributs/claims uniquement) | Guide migration OIDC - Gestion managée |
| OIDC | Gestion privée (flux + attributs) | Guide migration OIDC - Gestion privée |
| SAML v2 | Gestion managée (attributs uniquement) | Guide migration SAML - Gestion managée |
| SAML v2 | Gestion privée (flux + attributs) | Guide migration SAML - Gestion privée |

Exemples de code par cas : Exemples de code.
