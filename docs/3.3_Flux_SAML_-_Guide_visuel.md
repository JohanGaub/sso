...
> Les définitions générales (IdP, SP, Assertion, ACS, SLO...) sont dans **0. Migration SSO – Synthèse**, section 4.2. Le détail des attributs (Legacy vers Entra ID) est dans **1.3 Guide migration SAML - Gestion privée**, section **Attributs (Legacy vers IdP)**, et dans **3.4 Checklist de demande IAM - Raccordement SAML**.
